...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = [
    ...
    { path: '/events', changeFrequency: 'monthly' as const, priority: 0.7 },
    { path: '/events/investment-summit-2024', changeFrequency: 'yearly' as const, priority: 0.6 },
    { path: '/events/family-office-summit-2023', changeFrequency: 'yearly' as const, priority: 0.5 },
